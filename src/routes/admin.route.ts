...
router.get(
  ...
  adminController.countMessagesOfUser
);

/**
 * @swagger
 * /api/admin/conversations/count/{id}:
 *    get:
 *      summary: returns amount conversation of user
 *      tags: [Admins]
 *      parameters:
 *       - in: path
 *         name: id
...
router.get(
  ...
  activateMiddleware,
  roleMiddleware,
  adminController.countConversationsOfUser
);
